...
export interface AlertProps {
  ...
  autoClose?: boolean; // Optional prop to control auto close behavior
}
...
const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div className={`p-4 border-l-4 rounded-lg ${variantClasses[variant]} flex items-start space-x-3`}>
      {/* Icon */}
