...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="Construction Management App | Badges"
        description="Explore various badge components in the Construction Management App to enhance your UI with informative labels."
      />
