...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="Construction Management App | Avatars"
        description="Explore various avatar components in the Construction Management App to enhance user profiles and interactions."
      />
